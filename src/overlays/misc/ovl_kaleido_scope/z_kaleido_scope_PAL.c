...
u8 gItemAgeReqs[] = {
    ...
    AGE_REQ_NONE,  // ITEM_CUSTOM_1
    AGE_REQ_NONE,  // ITEM_CUSTOM_2
    AGE_REQ_NONE,  // ITEM_CUSTOM_3
    AGE_REQ_NONE,  // ITEM_CUSTOM_4
    AGE_REQ_NONE,  // ITEM_CUSTOM_5
    AGE_REQ_NONE,  // ITEM_CUSTOM_6
    AGE_REQ_NONE,  // ITEM_CUSTOM_7
    AGE_REQ_NONE,  // ITEM_CUSTOM_8
    AGE_REQ_NONE,  // ITEM_CUSTOM_9
    AGE_REQ_NONE,  // ITEM_CUSTOM_10
    AGE_REQ_NONE,  // ITEM_CUSTOM_11
    AGE_REQ_NONE,  // ITEM_CUSTOM_12
    AGE_REQ_NONE,  // ITEM_CUSTOM_13
    AGE_REQ_NONE,  // ITEM_CUSTOM_14
    AGE_REQ_NONE,  // ITEM_CUSTOM_15
    AGE_REQ_NONE,  // ITEM_CUSTOM_16
    AGE_REQ_NONE,  // ITEM_CUSTOM_17
    AGE_REQ_NONE,  // ITEM_CUSTOM_18
    AGE_REQ_NONE,  // ITEM_CUSTOM_19
