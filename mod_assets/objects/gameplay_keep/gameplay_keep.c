...
JointIndex sPocketCuccoAnimJointIndices[] = {
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0001, 0x0000 },
...
AnimationHeader gPocketCuccoAnim = { 
    { 10 }, sPocketCuccoAnimFrameData,
    sPocketCuccoAnimJointIndices, 18
};

u8 object_pocket_cucco_possiblePadding_0000F8[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
};

Vtx object_pocket_cuccoVtx_000100[] = {
#include "assets/objects/object_niw/object_niwVtx_000100.vtx.inc"
};

Gfx gPocketCuccoNeckDL[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gPocketCuccoBaseFeathersTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 8, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsSPSetGeometryMode(G_CULL_BACK),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPVertex(&object_pocket_cuccoVtx_000100[62], 15, 0),
...
Gfx gPocketCuccoHeadDL[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gPocketCuccoEyeTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR
                         | G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x003C, 0x003C),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_CULL_BACK),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPVertex(object_pocket_cuccoVtx_000100, 29, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSP2Triangles(4, 5, 6, 0, 6, 7, 4, 0),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gPocketCuccoHeadFeathersTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 16, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsSPVertex(&object_pocket_cuccoVtx_000100[29], 29, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    ...
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gPocketCuccoBeakTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 8, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gPocketCuccoCombTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x003C, 0x003C),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSP2Triangles(25, 26, 27, 0, 27, 28, 25, 0),
    gsSPVertex(&object_pocket_cuccoVtx_000100[58], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSPEndDisplayList(),
};

Gfx gPocketCuccoTailAndUndersideDL[] = {
    gsSPMatrix(0x0D000140, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPVertex(&object_pocket_cuccoVtx_000100[99], 6, 0),
    gsSPMatrix(0x0D000000, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    ...
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPSetGeometryMode(G_CULL_BACK),
    gsSPVertex(&object_pocket_cuccoVtx_000100[105], 24, 6),
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gPocketCuccoTailFeathersTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_MIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSP2Triangles(26, 27, 28, 0, 26, 28, 29, 0),
    gsSPVertex(&object_pocket_cuccoVtx_000100[129], 11, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetTextureLUT(G_TT_NONE),
...
Gfx gPocketCuccoRightWingDL[] = {
    ...
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPVertex(&object_pocket_cuccoVtx_000100[77], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 4, 0),
...
Gfx gPocketCuccoRightFootDL[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gPocketCuccoClawTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 16, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_NOMIRROR |
                         G_TX_CLAMP, 3, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x001C, 0x003C),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPVertex(&object_pocket_cuccoVtx_000100[96], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

Gfx gPocketCuccoLeftWingDL[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    ...
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPVertex(&object_pocket_cuccoVtx_000100[85], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 2, 0),
...
Gfx gPocketCuccoEffectFeatherModelDL[] = {
    gsSPVertex(object_pocket_cuccoVtx_002380, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

StandardLimb gPocketCuccoRootLimb = { 
    { 0, 0, 0 }, 0x01, LIMB_DONE,
    NULL
};

StandardLimb gPocketCuccoLimb_244C = { 
    { 0, 855, 262 }, 0x02, LIMB_DONE,
    NULL
};

StandardLimb gPocketCuccoLimb_2458 = { 
    { 0, 0, 0 }, 0x03, 0x0C,
    NULL
};

StandardLimb gPocketCuccoTailAndUndersideLimb = { 
    { 0, 0, 0 }, 0x04, LIMB_DONE,
    gPocketCuccoTailAndUndersideDL
};

StandardLimb gPocketCuccoLeftFootRootLimb = { 
    { 457, -640, 42 }, 0x05, 0x06,
    NULL
};

StandardLimb gPocketCuccoLeftFootLimb = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gPocketCuccoLeftFootDL
};

StandardLimb gPocketCuccoLeftWingRootLimb = { 
    { 37, 183, 252 }, 0x07, 0x08,
    NULL
};

StandardLimb gPocketCuccoLeftWingLimb = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gPocketCuccoLeftWingDL
};

StandardLimb gPocketCuccoRightFootRootLimb = { 
    { 457, -640, -42 }, 0x09, 0x0A,
    NULL
};

StandardLimb gPocketCuccoRightFootLimb = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gPocketCuccoRightFootDL
};

StandardLimb gPocketCuccoRightWingRootLimb = { 
    { 37, 183, -240 }, 0x0B, LIMB_DONE,
    NULL
};

StandardLimb gPocketCuccoRightWingLimb = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gPocketCuccoRightWingDL
};

StandardLimb gPocketCuccoUpperBodyRootLimb = { 
    { 0, 0, 0 }, 0x0D, LIMB_DONE,
    NULL
};

StandardLimb gPocketCuccoNeckLimb = { 
    { 0, 0, 0 }, 0x0E, LIMB_DONE,
    gPocketCuccoNeckDL
};

StandardLimb gPocketCuccoHeadLimb = { 
    { 834, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gPocketCuccoHeadDL
};

void* gPocketCuccoSkelLimbs[] = {
    &gPocketCuccoRootLimb,
    &gPocketCuccoLimb_244C,
    &gPocketCuccoLimb_2458,
    &gPocketCuccoTailAndUndersideLimb,
    &gPocketCuccoLeftFootRootLimb,
    &gPocketCuccoLeftFootLimb,
    &gPocketCuccoLeftWingRootLimb,
    &gPocketCuccoLeftWingLimb,
    &gPocketCuccoRightFootRootLimb,
    &gPocketCuccoRightFootLimb,
    &gPocketCuccoRightWingRootLimb,
    &gPocketCuccoRightWingLimb,
    &gPocketCuccoUpperBodyRootLimb,
    &gPocketCuccoNeckLimb,
    &gPocketCuccoHeadLimb,
};

FlexSkeletonHeader gPocketCuccoSkel = { 
    { gPocketCuccoSkelLimbs, ARRAY_COUNT(gPocketCuccoSkelLimbs) }, 7
};
