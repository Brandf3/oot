...
SurfaceType gMazeWall2DL_polygonTypes[] = {
	{ 0x00000000, 0x00000000 },
};

CollisionPoly gMazeWall2DL_polygons[] = {
...
CollisionHeader gMazeWall2DL_collisionHeader = {
	-5000, 0, -200,
	5000, 10000, 200,
	8,
	gMazeWall2DL_vertices,
	12,
	gMazeWall2DL_polygons,
	gMazeWall2DL_polygonTypes,
	0,
	0,
	0
};

Vtx gMazeWall2DL_gMazeWall2DL_mesh_layer_Opaque_vtx_0[24] = {
...
Gfx gMazeWall2DL_gMazeWall2DL_mesh_layer_Opaque_tri_0[] = {
	gsSPVertex(gMazeWall2DL_gMazeWall2DL_mesh_layer_Opaque_vtx_0 + 0, 16, 0),
	...
	gsSPVertex(gMazeWall2DL_gMazeWall2DL_mesh_layer_Opaque_vtx_0 + 16, 8, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 6, 7, 0),
...
Gfx mat_gMazeWall2DL_f3d_material_002_layerOpaque[] = {
	gsDPPipeSync(),
...
Gfx gMazeWall2DL[] = {
	gsSPDisplayList(mat_gMazeWall2DL_f3d_material_002_layerOpaque),
	gsSPDisplayList(gMazeWall2DL_gMazeWall2DL_mesh_layer_Opaque_tri_0),
	gsSPEndDisplayList(),
};
